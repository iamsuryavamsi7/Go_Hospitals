...
import HeadlessUIDialog from './HeadlesUIDialog'
import HeadlessUIDialog1 from './HeadlessUIDialog1'

export default function TransitionAnimation1({imgSrc, imgDesc, ImageURL}) {
